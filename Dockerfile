...
RUN apt-get update && apt-get install --no-install-recommends -y vim python3 python3-uvloop python3-cryptography python3-socks libcap2-bin ca-certificates && rm -rf /var/lib/apt/lists/*
